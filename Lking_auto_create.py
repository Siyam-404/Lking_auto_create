...
------------------------------------------
 Author : Siyam6252
 Github : Siyam-404 (Follow Must)
 Tools  : Auto Facebook Register
 Contact: +8801533969430
 Version: 1.6
\033[1;37m------------------------------------------""") 
try:
    clear()
    ...
    if "Version-1.5" in response:
        ...
        if kex in response:
            ...
            linex()
            print(" Your key: "+fkeyx);subprocess.check_output(["am", "start", "https://api.whatsapp.com/send?phone=+8801533969430&text="+(" Hi SIYAM sir i want Buy Auto Create Ids Tool Please Approve My Token\n Token:- "+ fkeyx)]);time.sleep(2)
